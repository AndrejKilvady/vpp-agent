...
Check2 Interfaces on Agent1 for Agent2 Repeat
    Repeat Show Info Any    Check2 Interfaces on Agent1 for Agent2
...
Check Interfaces on Agent1 for Agent3 Repeat
    Repeat Show Info Any    Check Interfaces on Agent1 for Agent3
...
Check Interfaces And FIB Repeted
    Repeat Show Info Any  Check Interfaces And FIB
...
Check Vpp Logs
    vpp_term: Show Vpp Logging    agent_vpp_1
    vpp_term: Show Vpp Logging    agent_vpp_2
    vpp_term: Show Vpp Logging    agent_vpp_3
